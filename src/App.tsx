...
function App() {
  return (
    <div className={`max-w-8xl mx-auto`}>
      <div
        className={`hero-grid h-[800px] flex justify-center items-center relative`}
      >
        ...
        <img
          ...
          alt="dot-background"
          className={`absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-[1200px]`}
        />
      </div>
    </div>
  );
