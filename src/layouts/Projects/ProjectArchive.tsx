        ...
        {archiveProjects.map((project) => (
          ...
          >
            ...
            <img
              ...
              aria-hidden="true"
              loading="lazy"
              className={`pointer-events-none absolute right-1/2 top-1/2 z-20 hidden w-[26vw] max-w-[28em] -translate-y-1/2 rounded-md border border-line shadow-2xl lg:group-hover:block`}
            />
          </li>
        ))}
      </ul>
