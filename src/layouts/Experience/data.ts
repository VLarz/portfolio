...
export const experienceData: Role[] = [
  {
    ...
    period: `Apr 2025 — now`,
    summary: `Mentoring, code reviews, onboarding, and automation workshops — top peer-voted recognition company-wide.`,
    current: true,
  },
  {
    ...
    summary: `Turned PDF brand guidelines into production component libraries for 20+ clients including Toyota, Volkswagen, and Bondi Sands.`,
  },
  {
